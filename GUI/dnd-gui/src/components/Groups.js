...
export function getGroups() {
    const res = fetch(window.apiURL + '/playermenu/getgroupsaves', {
        method: 'GET',
    })
...
async function apiCreateGroup(groupName) {
    ...
    const res = await fetch(window.apiURL + '/playermenu/savegroup', {
        method: 'POST',
        body: groupBody
    })
    .then((response) => {
...
async function apiLoadGroup(groupName) {
    const res = await fetch(window.apiURL + '/playermenu/loadgroup', {
        method: 'POST',
        body: groupName
    })
    .then((response) => {
...
async function apiDeleteGroupAsync(groupName) {
    const res = await fetch(window.apiURL + '/playermenu/deletegroup', {
        method: 'POST',
        body: groupName
    })
    .then((response) => {
