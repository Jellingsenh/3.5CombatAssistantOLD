...
async function apiRollInitiative(initNameList) {
    ...
    const res = fetch(window.apiURL + '/playermenu/rollinitiative', {
        method: 'POST',
        body: initNameList
    })
...
async function apiSetUpTurns() {
    const res = await fetch(window.apiURL + '/playermenu/setupturns', {
        method: 'GET',
    })
    .catch(err => {
        console.log(err);
...
async function apiUpdateInitiative(initNamesList) {
    ...
    const res = fetch(window.apiURL + '/playermenu/changeinitiative', {
        method: 'POST',
        body: initNamesList
    })
    .then(response => response.json())
