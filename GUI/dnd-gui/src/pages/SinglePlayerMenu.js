...
class SinglePlayerMenu extends React.Component {
    ...
    constructor(props) {
        ...
        this.loadCharacterSavesAlpha.bind(this);
        this.loadCharacterSavesAlpha();
    ...
    getAllCharacters = async () => {
        const res = await fetch(window.apiURL + '/playermenu/getcharacters/true', {
            method: 'GET',
        })
        ...
        const res2 = await fetch(window.apiURL + '/playermenu/getcharacters/false', {
            method: 'GET',
        })
        .then(response => response.json())
        .then(response => {
    ...
    getCharacterForEdit = async () => {
        ...
        try {
            const response = await fetch(window.apiURL + '/playermenu/getcharacter/' + this.state.currentCharacterName, {
                method: 'GET'
            })
    ...
    loadCharacterSaves = () => {
        const res = fetch(window.apiURL + '/playermenu/getcharactersaves/true', {
            method: 'GET',
        })
        .then(response => response.json())
        .then(response => {
    ...
    loadCharacterSavesAlpha = () => {
        const res = fetch(window.apiURL + '/playermenu/getcharactersaves/false', {
            method: 'GET',
        })
        .then(response => response.json())
        .then(response => {
            console.log('Character saves (alphabetical): ' + response );
            this.setState({
                characterSavesAlpha: response,
            });
        })
        .catch(err => {
            console.log(err);
    ...
    loadGameSaves = () => {
        const res = fetch(window.apiURL + '/playermenu/getgamesaves', {
            method: 'GET',
        })
        .then(response => response.json())
        .then(response => {
    ...
    getPcsForInitiative = () => {
        ...
        const res = fetch(window.apiURL + '/playermenu/getpcs', {
            method: 'GET',
        })
        .then(response => response.json())
        .then(response => {
            ...
            return (
                <div>
                    ...
                    <div className="modal1" style={{display: this.state.modal1Open ? 'block' : 'none', "position": "absolute", "top":"1%", "zIndex": "1", resizeMode: 'center'}}>
                        <div style={{"position": "center", "backgroundColor": "lightgrey", border: '5px solid lightgrey',borderRadius: '5px'}}>
                        ...
                        <div style={{"position": "fixed", maxWidth: '75%', "backgroundColor": "lightgrey", border: '5px solid lightgrey', borderRadius: '5px'}}>
                            {this.state.modal2Open ? 
                                <Paper style={{overflow: 'auto', 'backgroundColor':'white', border: '10px solid white', borderRadius: '5px'}}>
                                    <p>Choose a character to view / edit: </p>
                    ...
                    <div className="modal3" style={{display: this.state.modal3Open ? 'block' : 'none', "position": "absolute", "zIndex": "1", "top":"15%", resizeMode: 'center'}}>
                        <div style={{"position": "fixed", maxWidth:"75%", "backgroundColor": "lightgrey", border: '5px solid lightgrey',borderRadius: '5px'}}>
                            {this.state.modal3Open ? 
                                <Paper style={{overflow: 'auto', 'backgroundColor':'white', border: '10px solid white', borderRadius: '5px'}}>
                                    <p>Choose a character to duplicate: </p>
                                    <p style={{fontSize:"10px"}}>{'(Duplicating the same character multiple times will increment the name integer)'}</p>
                                    <div style={{"display": "flex", "flexDirection": "row", border: '20px solid white', borderRadius: '5px'}}>
                                        {Object.entries(this.state.characters).map((character) => (
                                            <div key={character}>
                                                <Button color="deeppurp" variant="outlined" style={{"color":"black", textTransform: "none", fontSize: "10px"}} onClick={() => pickNumberOfDuplicates(character[1])}>
                                                    {character[1]}
                                                </Button>&nbsp;&nbsp;
                                            </div>
                                        ))}
                        ...
                        <div style={{"position": "fixed", maxWidth: '75%', "backgroundColor": "lightgrey", border: '5px solid lightgrey',borderRadius: '5px'}}>
                            {this.state.modal9Open ? 
                                <Paper style={{overflow: 'auto', 'backgroundColor':'white', border: '10px solid white', borderRadius: '5px'}}>
                                    ...
                                    <Button color="editblue" style={{"color":"editblue", textTransform: "none", fontSize: "10px"}} onClick={() => this.setState({alphabetical: false,})}>
                                        Sort Chronologically
                                    </Button>:
                                    <Button color="editblue" style={{"color":"editblue", textTransform: "none", fontSize: "10px"}} onClick={() => this.setState({alphabetical: true,})}>
                                        Sort Alphabetically
                                    </Button>}
                                    <p></p>
                                    <div style={{"display": "flex", "flexDirection": "row"}}>
                                        {Object.entries(this.state.alphabetical ? this.state.characterSavesAlpha : this.state.characterSaves).map((character) => (
                    ...
                    <div style={{resizeMode: 'center',}}>
                        <h2>Dungeon Master Character Menu</h2>
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gridGap: 40 }}>
                            <div>
                                <h3>Current characters (in the map):</h3>
                                <Paper style={{maxHeight: 200, maxWidth: 600, overflow: 'auto', 'backgroundColor':'lightgrey'}}>
                                    {Object.entries(this.state.characters).map((character) => (
                                        <List key = {character}>
                                            <Button  size="small" style={{"color":"black",  textTransform: "none", fontSize: "10px"}} onClick={() => removeFromMapV2(character[1])}>
                            ...
                            <div>
                                ...
                                <Paper style={{maxHeight: 200, maxWidth: 600, overflow: 'auto', 'backgroundColor':'lightgrey'}}>
                                    {Object.entries(this.state.charactersNotInMap).map((character) => (
                                        <List key = {character}>
                                            <Button  size="small" style={{"color":"black",  textTransform: "none", fontSize: "10px"}} onClick={() => moveToMapV2(character[1])}>
                                                {"(<- move to map)"}&nbsp;&nbsp;&nbsp;&nbsp; 
                                                <div style={{"color":"black",  textTransform: "none", fontSize: "12px", fontWeight: 'bold'}}>{character[1]}</div>
                                            </Button>
                                        </List>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gridGap: 40 }}> {/* change to repeat(5, 1fr) */}
                            <div>
                                ...
                                <Stack spacing={1}>
                                    <Button size="small" color="secondary" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal1Open: true,})} variant="contained" endIcon={<ChildCare />}>
                                        Create a character
                                    </Button>
                                    <Button size="small" color="secondary" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal3Open: true,})} variant="contained" endIcon={<PersonAdd />}>
                                        Duplicate a character
                                    </Button>
                                    <Button size="small" color="editblue" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal2Open: true,})} variant="contained" endIcon={<Edit />}>
                                        View / Edit a character
                                    </Button>
                                    <Button size="small" color="deletered" style={{textTransform: "none", fontSize: "12px", color:'black'}} onClick={() => this.setState({modal4Open: true,})} variant="outlined" endIcon={<PersonRemove />}>
                                        Remove a character
                                    </Button>
                                </Stack>
                            </div>
                            <div>
                                ...
                                <Stack spacing={3}>
                                    <Button size="small" color="secondary" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal9Open: true,})} variant="contained" endIcon={<SaveAlt />}>
                                        Create a character save
                                    </Button>
                                    <Button size="small" color="editblue" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal5Open: true,})} variant="contained" endIcon={<Upload />}>
                                        Load a character save
                                    </Button>
                                    <Button size="small" color="deletered" style={{textTransform: "none", fontSize: "12px", color:'black'}} onClick={() => this.setState({modal6Open: true,})} variant="outlined" endIcon={<Clear />}>
                            ...
                            <div>
                                ...
                                <Stack spacing={3}>
                                    <Button size="small" color="secondary" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal12Open: true,})} variant="contained" endIcon={<GroupAdd />}>
                                        Create a group
                                    </Button>
                                    <Button size="small" color="editblue" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal13Open: true,})} variant="contained" endIcon={<PeopleOutline />}>
                                        Load a group
                                    </Button>
                                    <Button size="small" color="deletered" style={{textTransform: "none", fontSize: "12px", color:'black'}} onClick={() => this.setState({modal14Open: true,})} variant="outlined" endIcon={<GroupRemove />}>
                                        Delete a group
                                    </Button>
                                </Stack>
                            </div>
                            ...
                            <div>
                                ...
                                <Stack spacing={3}>
                                    <Button size="small" color="secondary" style={{textTransform: "none", fontSize: "12px"}} onClick={this.saveGameState.bind(this)} variant="contained" endIcon={<SaveAlt />}>
                                        Save game state
                                    </Button>
                                    <Button size="small" color="editblue" style={{textTransform: "none", fontSize: "12px"}} onClick={() => this.setState({modal7Open: true,})} variant="contained" endIcon={<Downloading />}>
                                        Load game state
                                    </Button>
                                    <Button size="small" color="deletered" style={{textTransform: "none", fontSize: "12px", color:'black'}} onClick={() => this.setState({modal8Open: true,})} variant="outlined" endIcon={<RemoveCircleOutline />}>
                                        Delete game state
                                    </Button>
                                </Stack>
                            </div>
                        ...
                        <div>
                            <Stack spacing={1}>
                                <p></p>
                                <Button size="small" color="dmblue" style={{textTransform: "none", color:'white'}} onClick={openDMOptions} variant="contained" endIcon={<AccessTime />}>
                                    Dungeon Master options
                                </Button>
                                <Button size="small" color="primary" style={{color:"black"}} onClick={this.getPcsForInitiative.bind(this)} variant="contained" endIcon={<PriorityHigh />}>
                                    Roll initiative
                                </Button>
                                <Button size="small" color="enterblue" onClick={this.playAsCharacter.bind(this)} variant="contained" endIcon={<Accessibility />}>
                                    Enter Game
                                </Button>
                            </Stack>
...
export function removeFromMapV2(charName) {
    if (charName != null && charName != '') {
...
function pickNumberOfDuplicates(charName) {
    var numberOfCopies = prompt('How many copies of ' + charName + ' do you want to create? (enter a number):');
    apiDuplicateCharacter(charName, numberOfCopies);
}

async function apiDuplicateCharacter(charName, numberOfCopies) {
    console.log('numberofcopies: ' + numberOfCopies);

    const res = await fetch(window.apiURL + '/playermenu/duplicatecharacter', {
        method: 'POST',
        body: JSON.stringify({
...
async function apiRemoveCharacter(charName) {
    const res = await fetch(window.apiURL + '/playermenu/removecharacter', {
        method: 'POST',
        body: charName
    })
    .then((response) => {
...
async function apiMoveCharacterToMap(charName, mapLoc) {
    ...
    const res = await fetch(window.apiURL + '/playermenu/movetomap', {
        method: 'POST',
        body: charName
    })
    .then((response) => {
...
async function apiRemoveCharacterFromMap(charName) {
    const res = await fetch(window.apiURL + '/playermenu/removefrommap', {
        method: 'POST',
        body: charName
    })
    .then((response) => {
...
async function apiSaveCharacter(charName) {
    const res = await fetch(window.apiURL + '/playermenu/savecharacter', {
        method: 'POST',
        body: charName
    })
    .then((response) => {
...
async function apiLoadCharacterSave(charName) {
    const res = await fetch(window.apiURL + '/playermenu/loadcharacter', {
        method: 'POST',
        body: charName
    })
    .then((response) => {
...
async function apiDeleteCharacterSaveAsync(charName) {
    const res = await fetch(window.apiURL + '/playermenu/deletecharacter', {
        method: 'POST',
        body: charName
    })
    .then((response) => {
...
async function apiSaveGameState(gameName) {
    const res = await fetch(window.apiURL + '/playermenu/savegame', {
        method: 'POST',
        body: gameName
    })
    .then((response) => {
...
async function apiLoadGameState(gameName) {
    const res = await fetch(window.apiURL + '/playermenu/loadgame', {
        method: 'POST',
        body: gameName
    })
    .then((response) => {
...
async function apiDeleteGameState(gameName) {
    const res = await fetch(window.apiURL + '/playermenu/deletegame', {
        method: 'POST',
        body: gameName
    })
    .then((response) => {
